## Bài tập: Tìm hiểu và trả lời các câu hỏi sau, trả lời bằng cách xây dựng một trang html cơ bản (mẫu example.html === tạo file mới có tên index.html. tuyệt đối không sửa file example)
